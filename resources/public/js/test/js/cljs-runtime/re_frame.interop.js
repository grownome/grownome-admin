...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__6000 = cljs.core.instance_QMARK_;
var expr__6001 = reactive_val;
if(cljs.core.truth_((pred__6000.cljs$core$IFn$_invoke$arity$2 ? pred__6000.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__6001) : pred__6000.call(null,reagent.ratom.RAtom,expr__6001)))){
return "ra";
} else {
if(cljs.core.truth_((pred__6000.cljs$core$IFn$_invoke$arity$2 ? pred__6000.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__6001) : pred__6000.call(null,reagent.ratom.RCursor,expr__6001)))){
return "rc";
} else {
if(cljs.core.truth_((pred__6000.cljs$core$IFn$_invoke$arity$2 ? pred__6000.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__6001) : pred__6000.call(null,reagent.ratom.Reaction,expr__6001)))){
return "rx";
} else {
if(cljs.core.truth_((pred__6000.cljs$core$IFn$_invoke$arity$2 ? pred__6000.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__6001) : pred__6000.call(null,reagent.ratom.Track,expr__6001)))){
return "tr";
} else {
return "other";
}
