...
var G__5725 = devtools.prefs.pref(v);
v = G__5725;
continue;
} else {
return v;
...
}catch (e5745){var _e__4364__auto__ = e5745;
return false;
}})();
...
}catch (e5753){var _e__4364__auto__ = e5753;
return false;
}})();
...
}catch (e5766){var _e__4364__auto__ = e5766;
return false;
}}
}
});
...
var vec__5778 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5778,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5778,(1),null);
...
return cljs.core.some((function (p1__5781_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__5781_SHARP_);
}),template);
});
