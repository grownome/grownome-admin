...
var base_style__$1 = (cljs.core.truth_((function (){var and__3938__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__3938__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__3938__auto__)){
...
var G__8738_8741 = re_com.selection_list.check_clicked(selections,item_id,cljs.core.not((selections.cljs$core$IFn$_invoke$arity$1 ? selections.cljs$core$IFn$_invoke$arity$1(item_id) : selections.call(null,item_id))),required_QMARK_);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__8738_8741) : on_change.call(null,G__8738_8741));
}

return null;
});})(item_id))
], null),new cljs.core.Keyword(null,"child","child",623967545),new cljs.core.PersistentVector(null, 11, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.misc.checkbox,new cljs.core.Keyword(null,"model","model",331153215),!(((selections.cljs$core$IFn$_invoke$arity$1 ? selections.cljs$core$IFn$_invoke$arity$1(item_id) : selections.call(null,item_id)) == null)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (item_id){
return (function (){
...
var G__8749_8750 = re_com.selection_list.radio_clicked(selections,item_id,required_QMARK_);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__8749_8750) : on_change.call(null,G__8749_8750));
}

return null;
});})(item_id))
], null),new cljs.core.Keyword(null,"child","child",623967545),new cljs.core.PersistentVector(null, 13, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.misc.radio_button,new cljs.core.Keyword(null,"model","model",331153215),cljs.core.first(selections),new cljs.core.Keyword(null,"value","value",305978217),item_id,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (item_id){
return (function (){
return cljs.core.List.EMPTY;
});})(item_id))
,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181),disabled_QMARK_,new cljs.core.Keyword(null,"label-style","label-style",-1703650121),re_com.selection_list.label_style.cljs$core$IFn$_invoke$arity$2((selections.cljs$core$IFn$_invoke$arity$1 ? selections.cljs$core$IFn$_invoke$arity$1(item_id) : selections.call(null,item_id)),as_exclusions_QMARK_),new cljs.core.Keyword(null,"label","label",1718410804),(label_fn.cljs$core$IFn$_invoke$arity$1 ? label_fn.cljs$core$IFn$_invoke$arity$1(item) : label_fn.call(null,item))], null)], null);
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__8769){
var map__8770 = p__8769;
var map__8770__$1 = ((((!((map__8770 == null)))?(((((map__8770.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8770.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__8770):map__8770);
var args = map__8770__$1;
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8770__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8770__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8770__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var item_renderer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8770__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8770__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8770__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8770__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8770__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var max_height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8770__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var hide_border_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8770__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8770__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var choices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8770__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8770__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8770__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.cljs$core$IFn$_invoke$arity$variadic(re_com.validate.extract_arg_data(re_com.selection_list.selection_list_args_desc),args,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["selection-list"], 0))))){
} else {
...
var items = cljs.core.map.cljs$core$IFn$_invoke$arity$2((cljs.core.truth_(item_renderer)?((function (selected,map__8770,map__8770__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__8766_SHARP_){
return (item_renderer.cljs$core$IFn$_invoke$arity$8 ? item_renderer.cljs$core$IFn$_invoke$arity$8(p1__8766_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_) : item_renderer.call(null,p1__8766_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_));
});})(selected,map__8770,map__8770__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__8770,map__8770__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__8767_SHARP_){
return re_com.selection_list.as_checked(p1__8767_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__8770,map__8770__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__8770,map__8770__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__8768_SHARP_){
return re_com.selection_list.as_radio(p1__8768_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__8770,map__8770__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
)),choices);
...
args__4534__auto__.push((arguments[i__4532__auto___8828]));
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__4535__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__8799){
var map__8801 = p__8799;
var map__8801__$1 = ((((!((map__8801 == null)))?(((((map__8801.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8801.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__8801):map__8801);
var args = map__8801__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.cljs$core$IFn$_invoke$arity$variadic(re_com.validate.extract_arg_data(re_com.selection_list.selection_list_args_desc),args,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["selection-list"], 0))))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__8801,map__8801__$1,args){
return (function() { 
var G__8839__delegate = function (p__8812){
var map__8815 = p__8812;
var map__8815__$1 = ((((!((map__8815 == null)))?(((((map__8815.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8815.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__8815):map__8815);
var args__$1 = map__8815__$1;
...
while (G__8840__i < G__8840__a.length) {G__8840__a[G__8840__i] = arguments[G__8840__i + 0]; ++G__8840__i;}
  p__8812 = new cljs.core.IndexedSeq(G__8840__a,0,null);
} 
return G__8839__delegate.call(this,p__8812);};
G__8839.cljs$lang$maxFixedArity = 0;
G__8839.cljs$lang$applyTo = (function (arglist__8841){
var p__8812 = cljs.core.seq(arglist__8841);
return G__8839__delegate(p__8812);
});
G__8839.cljs$core$IFn$_invoke$arity$variadic = G__8839__delegate;
return G__8839;
})()
;
;})(map__8801,map__8801__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

/** @this {Function} */
re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq8793){
var self__4519__auto__ = this;
return self__4519__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq8793));
});
