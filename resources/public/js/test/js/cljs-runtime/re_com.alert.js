...
var len__4531__auto___8073 = arguments.length;
var i__4532__auto___8074 = (0);
while(true){
if((i__4532__auto___8074 < len__4531__auto___8073)){
args__4534__auto__.push((arguments[i__4532__auto___8074]));

var G__8075 = (i__4532__auto___8074 + (1));
i__4532__auto___8074 = G__8075;
continue;
} else {
}
break;
...
return re_com.alert.alert_box.cljs$core$IFn$_invoke$arity$variadic(argseq__4535__auto__);
});

re_com.alert.alert_box.cljs$core$IFn$_invoke$arity$variadic = (function (p__8054){
...
var args = map__8055__$1;
var closeable_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8055__$1,new cljs.core.Keyword(null,"closeable?","closeable?",1490064409));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8055__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8055__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8055__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var on_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8055__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var alert_type = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__8055__$1,new cljs.core.Keyword(null,"alert-type","alert-type",405751817),new cljs.core.Keyword(null,"info","info",-317069002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8055__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8055__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8055__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var padding = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8055__$1,new cljs.core.Keyword(null,"padding","padding",1660304693));
...
/** @this {Function} */
re_com.alert.alert_box.cljs$lang$applyTo = (function (seq8051){
var self__4519__auto__ = this;
return self__4519__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq8051));
});
...
var argseq__4535__auto__ = ((((0) < args__4534__auto__.length))?(new cljs.core.IndexedSeq(args__4534__auto__.slice((0)),(0),null)):null);
return re_com.alert.alert_list.cljs$core$IFn$_invoke$arity$variadic(argseq__4535__auto__);
});

re_com.alert.alert_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__8116){
var map__8117 = p__8116;
var map__8117__$1 = ((((!((map__8117 == null)))?(((((map__8117.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8117.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__8117):map__8117);
var args = map__8117__$1;
var alerts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8117__$1,new cljs.core.Keyword(null,"alerts","alerts",-2121664427));
var on_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8117__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var max_height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8117__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var padding = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__8117__$1,new cljs.core.Keyword(null,"padding","padding",1660304693),"4px");
var border_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8117__$1,new cljs.core.Keyword(null,"border-style","border-style",-485574304));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8117__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8117__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8117__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8124__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var alert_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8124__$1,new cljs.core.Keyword(null,"alert-type","alert-type",405751817));
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8124__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8124__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var padding__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8124__$1,new cljs.core.Keyword(null,"padding","padding",1660304693));
var closeable_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8124__$1,new cljs.core.Keyword(null,"closeable?","closeable?",1490064409));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__8122),re_com$alert$iter__8119(cljs.core.chunk_rest(s__8120__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__8122),null);
}
} else {
var alert = cljs.core.first(s__8120__$2);
return cljs.core.cons((function (){var map__8131 = alert;
var map__8131__$1 = ((((!((map__8131 == null)))?(((((map__8131.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8131.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__8131):map__8131);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8131__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var alert_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8131__$1,new cljs.core.Keyword(null,"alert-type","alert-type",405751817));
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8131__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8131__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var padding__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8131__$1,new cljs.core.Keyword(null,"padding","padding",1660304693));
var closeable_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8131__$1,new cljs.core.Keyword(null,"closeable?","closeable?",1490064409));
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 15, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.alert.alert_box,new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"alert-type","alert-type",405751817),alert_type,new cljs.core.Keyword(null,"heading","heading",-1312171873),heading,new cljs.core.Keyword(null,"body","body",-2049205669),body,new cljs.core.Keyword(null,"padding","padding",1660304693),padding__$1,new cljs.core.Keyword(null,"closeable?","closeable?",1490064409),closeable_QMARK_,new cljs.core.Keyword(null,"on-close","on-close",-761178394),on_close], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null));
})(),re_com$alert$iter__8119(cljs.core.rest(s__8120__$2)));
}
} else {
return null;
}
...
});})(alerts__$1,map__8117,map__8117__$1,args,alerts,on_close,max_height,padding,border_style,class$,style,attr))
,null,null));
});})(alerts__$1,map__8117,map__8117__$1,args,alerts,on_close,max_height,padding,border_style,class$,style,attr))
;
return iter__4324__auto__(alerts__$1);
...
/** @this {Function} */
re_com.alert.alert_list.cljs$lang$applyTo = (function (seq8115){
var self__4519__auto__ = this;
return self__4519__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq8115));
});
