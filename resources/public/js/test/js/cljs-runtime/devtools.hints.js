...
var G__5782 = cljs.core.PersistentArrayMap.EMPTY;
var G__5783 = native_stack_trace;
var G__5784 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__5785 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__5782,G__5783,G__5784,G__5785) : cljs.stacktrace.parse_stacktrace.call(null,G__5782,G__5783,G__5784,G__5785));
});
...
var map__5792 = top_item;
var map__5792__$1 = ((((!((map__5792 == null)))?(((((map__5792.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5792.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__5792):map__5792);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5792__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5792__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5792__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e5791){var _e = e5791;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___5796 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5455__auto___5796)){
var seen_errors_5797 = temp__5455__auto___5796;
if(cljs.core.truth_(seen_errors_5797.has(self))){
} else {
seen_errors_5797.add(self);

var temp__5457__auto___5799 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5457__auto___5799)){
var sense_5800 = temp__5457__auto___5799;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_5800)].join('');
} else {
}
}
} else {
