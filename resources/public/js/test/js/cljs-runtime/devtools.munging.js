...
var o4747 = temp__5455__auto__;
var temp__5455__auto____$1 = (o4747["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o4748 = temp__5455__auto____$1;
return (o4748["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__4345__auto__ = f;
return (o__4345__auto__["toString"]).call(o__4345__auto__);
} else {
return "";
}
}catch (e4770){var _ = e4770;
return "";
}});
...
try{var o__4345__auto___4805 = t;
(o__4345__auto___4805["cljs$lang$ctorPrWriter"]).call(o__4345__auto___4805,t,writer);
}catch (e4797){var __4806 = e4797;
}
...
var char_code = (function (){var o__4345__auto__ = (new String(char$));
return (o__4345__auto__["charCodeAt"]).call(o__4345__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__4345__auto__ = String;
return (o__4345__auto__["fromCharCode"]).call(o__4345__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__4852 = num_code;
switch (G__4852) {
case (1):
return (185);
...
var o__4345__auto__ = String;
return (o__4345__auto__["fromCharCode"]).call(o__4345__auto__,superscript_code);
});
/**
...
}catch (e4922){var _e__4364__auto__ = e4922;
return false;
}})())){
...
var vec__4928 = devtools.munging.parse_fn_source(fn_source);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o5025 = temp__5455__auto__;
var temp__5455__auto____$1 = (o5025["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o5026 = temp__5455__auto____$1;
return (o5026["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___5064 = arguments.length;
var i__4532__auto___5065 = (0);
while(true){
if((i__4532__auto___5065 < len__4531__auto___5064)){
args__4534__auto__.push((arguments[i__4532__auto___5065]));

var G__5072 = (i__4532__auto___5065 + (1));
i__4532__auto___5065 = G__5072;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__5049){
var vec__5056 = p__5049;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5056,(0),null);
...
var G__5076 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__5077 = cljs.core.butlast(remaining_tokens);
name_tokens = G__5076;
remaining_tokens = G__5077;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq5040){
var G__5041 = cljs.core.first(seq5040);
var seq5040__$1 = cljs.core.next(seq5040);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__5041,seq5040__$1);
});
...
var vec__5098 = cljs.core.split_with((function (p1__5097_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__5097_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5098,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5098,(1),null);
...
var vec__5112 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5112,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5112,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__5121 = cljs.core.rest(remaining_tokens);
var G__5122 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__5121;
name_tokens = G__5122;
continue;
} else {
...
var vec__5136 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5136,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5136,(1),null);
var vec__5139 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5139,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5139,(1),null);
var vec__5142 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5142,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5142,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5142,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5142,(3),null);
...
var vec__5167 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5167,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5167,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5167,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5167,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5167,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5167,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__5189 = temp__5455__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5189,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5189,(1),null);
var vec__5192 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5192,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5192,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__5221 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__5221) : devtools.munging.parse_fn_info_deep.call(null,G__5221));
})()));
}
} else {
return fn_info;
...
var G__5267 = (arity + (1));
var G__5268 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__5280){
var vec__5281 = p__5280;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5281,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5281,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__5310_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__5311_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___5344 = arguments.length;
var i__4532__auto___5345 = (0);
while(true){
if((i__4532__auto___5345 < len__4531__auto___5344)){
args__4534__auto__.push((arguments[i__4532__auto___5345]));

var G__5349 = (i__4532__auto___5345 + (1));
i__4532__auto___5345 = G__5349;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__5337){
var vec__5339 = p__5337;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5339,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq5330){
var G__5332 = cljs.core.first(seq5330);
var seq5330__$1 = cljs.core.next(seq5330);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__5332,seq5330__$1);
});
...
var G__5366 = arg;
var G__5366__$1 = (((G__5366 instanceof cljs.core.Keyword))?G__5366.fqn:null);
switch (G__5366__$1) {
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5421__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5421__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5421__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5421__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__5422 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5422,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5422,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5422,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5422,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5422,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5422,(5),null);
...
var o__4345__auto__ = f;
return (o__4345__auto__["getBasis"]).call(o__4345__auto__);
});
/**
...
}catch (e5455){var _e__4364__auto__ = e5455;
...
var G__5470 = (obj[cljs.core.first(path)]);
var G__5471 = cljs.core.rest(path);
obj = G__5470;
path = G__5471;
continue;
} else {
...
return (function (accum,p__5523){
var vec__5524 = p__5523;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5524,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5524,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__5548){
var vec__5549 = p__5548;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5549,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5549,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5549,(2),null);
...
return (function (p__5563){
var vec__5565 = p__5563;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5565,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5565,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__5565,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__5558_SHARP_){
return (obj[cljs.core.first(p1__5558_SHARP_)]);
});})(name,sorted_matches,vec__5565,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
