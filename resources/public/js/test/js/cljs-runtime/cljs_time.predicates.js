...
var or__3949__auto__ = cljs_time.predicates.saturday_QMARK_(date_time);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
return cljs_time.predicates.sunday_QMARK_(date_time);
}
});
cljs_time.predicates.weekday_QMARK_ = (function cljs_time$predicates$weekday_QMARK_(date_time){
return cljs.core.not(cljs_time.predicates.weekend_QMARK_(date_time));
});
