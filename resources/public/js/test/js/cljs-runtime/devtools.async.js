...
return cljs.core.not((function (){var and__3938__auto__ = goog.labs.userAgent.browser.isChrome();
...
var o__4345__auto___5738 = (function (){var o__4345__auto__ = (function (){var o__4345__auto__ = Promise;
return (o__4345__auto__["resolve"]).call(o__4345__auto__);
})();
return (o__4345__auto__["then"]).call(o__4345__auto__,callback);
})();
(o__4345__auto___5738["catch"]).call(o__4345__auto___5738,devtools.async.rethrow_outside_promise);
...
var G__5749_5762 = Error;
var target__4356__auto___5763 = G__5749_5762;
if(cljs.core.truth_(target__4356__auto___5763)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["unable to locate object path ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(null)," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__5749_5762)].join('')),"\n","target__4356__auto__"].join('')));
}

(target__4356__auto___5763["stackTraceLimit"] = Infinity);
