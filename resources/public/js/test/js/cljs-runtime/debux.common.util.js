...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__9616_SHARP_){
return !(cljs.core.contains_QMARK_(result,p1__9616_SHARP_));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__9615_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__9615_SHARP_),"#"].join('');
...
return (((p1__9617_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__9617_SHARP_) == null)));
});})(gen_name,name_for))
 ...
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__9624,mapping){
...
var state = map__9625__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9625__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9625__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9625__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (map__9625,map__9625__$1,state,context,refers,aliases){
...
});})(map__9625,map__9625__$1,state,context,refers,aliases))
,mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (map__9625,map__9625__$1,state,context,refers,aliases){
return (function (p1__9622_SHARP_){
var and__3938__auto__ = (p1__9622_SHARP_ instanceof cljs.core.Symbol);
if(and__3938__auto__){
return cljs.core.namespace(p1__9622_SHARP_);
} else {
...
var G__9632 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__9633 = clojure.zip.next(loc);
loc = G__9633;
continue;
}
}
...
var len__4531__auto___9655 = arguments.length;
var i__4532__auto___9656 = (0);
while(true){
if((i__4532__auto___9656 < len__4531__auto___9655)){
args__4534__auto__.push((arguments[i__4532__auto___9656]));

var G__9657 = (i__4532__auto___9656 + (1));
i__4532__auto___9656 = G__9657;
continue;
} else {
}
break;
...
debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__9651){
var vec__9652 = p__9651;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9652,(0),null);
...
/** @this {Function} */
debux.common.util.form_header.cljs$lang$applyTo = (function (seq9649){
var G__9650 = cljs.core.first(seq9649);
var seq9649__$1 = cljs.core.next(seq9649);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9650,seq9649__$1);
});

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__9660_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__9660_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR_9664_9666 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR_9665_9667 = cljs.core._STAR_print_fn_STAR_;
cljs.core._STAR_print_newline_STAR_ = true;

cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_newline_STAR_9664_9666,_STAR_print_fn_STAR_9665_9667,sb__4462__auto__,res){
return (function (x__4463__auto__){
return sb__4462__auto__.append(x__4463__auto__);
});})(_STAR_print_newline_STAR_9664_9666,_STAR_print_fn_STAR_9665_9667,sb__4462__auto__,res))
;

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_9665_9667;

cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR_9664_9666;
}
...
return debux.common.util.prepend_bars(p1__9663_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__9670 = cljs.core.next(opts__$1);
var G__9671 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__9670;
acc = G__9671;
continue;
} else {
if(typeof f === 'string'){
var G__9672 = cljs.core.next(opts__$1);
var G__9673 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__9672;
acc = G__9673;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__9674 = cljs.core.nnext(opts__$1);
var G__9675 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__9674;
acc = G__9675;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__9676 = cljs.core.next(opts__$1);
var G__9677 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__9676;
acc = G__9677;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__9668 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__9668.cljs$core$IFn$_invoke$arity$1 ? fexpr__9668.cljs$core$IFn$_invoke$arity$1(f) : fexpr__9668.call(null,f));
})())){
var G__9678 = cljs.core.next(opts__$1);
var G__9679 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__9678;
acc = G__9679;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__9669 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__9669.cljs$core$IFn$_invoke$arity$1 ? fexpr__9669.cljs$core$IFn$_invoke$arity$1(f) : fexpr__9669.call(null,f));
})())){
var G__9681 = cljs.core.nnext(opts__$1);
var G__9682 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__9681;
acc = G__9682;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__9683 = cljs.core.next(opts__$1);
var G__9684 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__9683;
acc = G__9684;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__9685){
var vec__9686 = p__9685;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9686,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9686,(1),null);
...
var G__9693 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__9692 = (function (){var fexpr__9694 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__9694.cljs$core$IFn$_invoke$arity$1 ? fexpr__9694.cljs$core$IFn$_invoke$arity$1(form) : fexpr__9694.call(null,form));
})();
return (fexpr__9692.cljs$core$IFn$_invoke$arity$1 ? fexpr__9692.cljs$core$IFn$_invoke$arity$1(G__9693) : fexpr__9692.call(null,G__9693));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__9712 = quoted_form;
var G__9713 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__9712,G__9713) : debux.common.util.remove_d.call(null,G__9712,G__9713));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__9714 = quoted_form;
var G__9715 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__9714,G__9715) : debux.common.util.remove_d.call(null,G__9714,G__9715));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__9718__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__9716 = quoted_form;
var G__9717 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__9716,G__9717) : debux.common.util.remove_d.call(null,G__9716,G__9717));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__9719__i < G__9719__a.length) {G__9719__a[G__9719__i] = arguments[G__9719__i + 0]; ++G__9719__i;}
  arg = new cljs.core.IndexedSeq(G__9719__a,0,null);
} 
return G__9718__delegate.call(this,arg);};
G__9718.cljs$lang$maxFixedArity = 0;
G__9718.cljs$lang$applyTo = (function (arglist__9721){
var arg = cljs.core.seq(arglist__9721);
return G__9718__delegate(arg);
});
...
var G__9722 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__9722;
continue;
} else {
...
var G__9723 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__9723;
continue;
} else {
var G__9724 = clojure.zip.next(loc);
loc = G__9724;
continue;
