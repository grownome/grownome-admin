...
var len__4531__auto___5817 = arguments.length;
var i__4532__auto___5818 = (0);
while(true){
if((i__4532__auto___5818 < len__4531__auto___5817)){
args__4534__auto__.push((arguments[i__4532__auto___5818]));

var G__5819 = (i__4532__auto___5818 + (1));
i__4532__auto___5818 = G__5819;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq5814){
var G__5815 = cljs.core.first(seq5814);
var seq5814__$1 = cljs.core.next(seq5814);
var G__5816 = cljs.core.first(seq5814__$1);
var seq5814__$2 = cljs.core.next(seq5814__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__5815,G__5816,seq5814__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__5827_SHARP_){
return !((cljs.core.meta(p1__5827_SHARP_) == null));
})))){
...
var map__5845 = opts;
var map__5845__$1 = ((((!((map__5845 == null)))?(((((map__5845.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5845.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__5845):map__5845);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5845__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e5849){var _e__4364__auto__ = e5849;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e5851){var _e__4364__auto__ = e5851;
return false;
}}
})())){
...
var _STAR_current_state_STAR_5853 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state();

try{var map__5854 = opts;
var map__5854__$1 = ((((!((map__5854 == null)))?(((((map__5854.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5854.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__5854):map__5854);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5854__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_5853;
}});
...
;
var temp__5455__auto___5858 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5455__auto___5858)){
var managed_print_level_5859 = temp__5455__auto___5858;
var _STAR_print_level_STAR_5857_5860 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_5859;

try{devtools.formatters.state.update_current_state_BANG_(((function (_STAR_print_level_STAR_5857_5860,managed_print_level_5859,temp__5455__auto___5858,writer,opts,job_fn){
return (function (p1__5856_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__5856_SHARP_,null);
});})(_STAR_print_level_STAR_5857_5860,managed_print_level_5859,temp__5455__auto___5858,writer,opts,job_fn))
);

job_fn();
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_5857_5860;
}} else {
job_fn();
}
